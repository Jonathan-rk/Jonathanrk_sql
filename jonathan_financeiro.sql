...
--
-- Banco de dados: `jonathan_financeiro`
--
CREATE DATABASE IF NOT EXISTS `jonathan_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `jonathan_financeiro`;
...
(1, 'Jonathan Redmerski Kalinsoki', '023.456.789-10'),
(2, 'Area starque', '123.123.111-11');
