...
--
-- Banco de dados: `jonathankalinoskiestoque`
--
CREATE DATABASE IF NOT EXISTS `jonathankalinoskiestoque` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `jonathankalinoskiestoque`;
...
CREATE TABLE `cliente` (
  `cod_cliente` int(11) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do Código do cliente.',
  `nome_cliente` varchar(50) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do Nome do cliente.',
  `endereco` varchar(50) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do Endereço.',
  `cidade` varchar(50) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do Cidade.',
  `cep` varchar(10) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do l.',
  `uf` char(2) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do Estado (UF).',
  `cnpj` varchar(30) NOT NULL,
  `ie` int(10) NOT NULL COMMENT 'Esse campo é responsavel de armazenar a identificação do IE.'
